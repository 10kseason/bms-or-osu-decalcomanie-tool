...
**Generate random clipboard**는 시작 ms를 입력받아 osu timestamp 텍스트를 클립보드에 복사합니다.

예시:

```text
01:07:061 (67061|3,67061|2,67061|1,67061|8,67061|9) -
```

osu 에디터에 직접 붙여넣는 용도가 아니라, 텍스트 파일이나 메모에 붙여넣어 기록하기 위한 형식입니다.
